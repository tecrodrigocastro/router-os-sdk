...
All of these except `laravel-usage.php` and `wireguard-bootstrap.php`
require an actual reachable RouterOS device; `concurrent-reactor.php` and
`managed-client.php` are the most interesting ones to run.
